...
import TransactionList from "../components/Transactions/TransactionListView.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/accountmanagement/editaccount/:id",
      component: EditAccount,
      props: true,
    },
    { path: "/transactionmanagement", component: TransactionManagement },
    { path: "/usermanagement", component: UserManagement },
    { path: "/transaction/onaccount", component: TransactionList },
  ],
});
